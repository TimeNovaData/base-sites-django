            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        serialize=False,
                        to="novadata_utils.novadatamodel",
                    ),
                ),
                (
                    "email_backend",
                ...
                (
                    "email_use_tls",
                    models.BooleanField(default=True, verbose_name="EMAIL_USE_TLS"),
                ),
                (
                    "email_host",
                    models.CharField(
                ...
                (
                    "email_port",
                    models.IntegerField(default=587, verbose_name="EMAIL_PORT"),
                ),
                (
                    "email_host_user",
                    models.CharField(
                ...
                (
                    "email_name",
                    models.CharField(
                        default="Novadata", max_length=100, verbose_name="EMAIL_NAME"
                    ),
                ),
            ],
            options={

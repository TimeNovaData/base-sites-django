	...
	plugins: [
		plugin(function ({ addUtilities, theme }) {
			...
			addUtilities({
				...
				'.text-paragraph-1': { fontSize: '1.125rem', lineHeight: '1.625rem', 'letterSpacing': '-0.02rem', fontFamily: theme('fontFamily.sans') },
				'.text-paragraph-2': { fontSize: '1rem', lineHeight: '1.5rem', 'letterSpacing': '-0.02rem', fontFamily: theme('fontFamily.sans') },
				'.text-paragraph-3': { fontSize: '0.875remm', lineHeight: '1.5rem', 'letterSpacing': '-0.018rem', fontFamily: theme('fontFamily.sans') },
				'.text-paragraph-4': { fontSize: '0.75remm', lineHeight: '1.5rem', 'letterSpacing': '-0.015rem', fontFamily: theme('fontFamily.sans') },
				'.text-paragraph-5': { fontSize: '0.675remm', lineHeight: '1.5rem', 'letterSpacing': '-0.013rem', fontFamily: theme('fontFamily.sans') },
			})
		}),
	],
}
